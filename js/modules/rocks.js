	...
	return {
		...
		_whatwedo: function() {
			...
			$rocks.each(function() {
				...
				var posData = 'top[swing]:' + (frames.end.y - (sh + $this.height())) + 'px;';
			...
			$meteor.attr('data-top-center', 'top:0px;display:!block;');
			$meteor.attr('data-center-bottom', 'display:!none;');
			...
			$whatWeContainer.attr('data--3200-top', "top:-400px;");
			$whatWeContainer.attr('data--4200-top', "top:" + -sh + "px;");
			$whatWeContainer.attr('data-top-bottom', "top:" + -sh + "px;display:!none;");

			// Set the what we do section behaviour 
			$('#js-whatwedo-section').height(4500);
		},
		...
		_whoweare: function() {
			...
			$biosContainer.attr('data-0', 'top:0px;position:!absolute;');
			$biosContainer.attr('data-1200-center-top', 'transform[swing]:translate(0,' + (sh + $rock1.height()) + 'px);position:!fixed;display:!block;');
			$biosContainer.attr('data-top-bottom', 'transform:translate(0,' + -(sh * 1) + 'px);display:!none;');

			$rock1.attr('data-0', 'top:0px;position:!absolute;');
			$rock1.attr('data-100-center-top', 'transform:translate(0,' + sh + 'px);position:!fixed;display:!block;' );
			$rock1.attr('data-top-bottom', 'transform:translate(0,' + -(sh * 0.6) + 'px);display:!none;' );

			$('#js-whoweare-section').height(sh + 600);
		},
		...
		_ourwork: function() {
			...
			$meteors.attr('data-bottom-top', 'transform:translate(0,' + sh + 'px);position:!fixed;');
			$meteors.attr('data-top-bottom', 'transform:translate(0, -100px);display:!none;');
		}
	};
